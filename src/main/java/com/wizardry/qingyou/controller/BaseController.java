...
public class BaseController {
    ...
    // 注册成功
    public static int registerSuccess = 2001;
    // 登陆成功
    public static int loginSuccess = 2002;

    //请求处理的方法
    //自动将异常对象传递给此方法的参数列表上
    //当项目中产生了异常，被统一拦截到此方法当中，这个方法就相当于处理方法，方法的返回值传递给前端
    @ExceptionHandler({ServiceException.class, FileUploadException.class})// 这个注解修饰的的方法，用于统一处理抛出的异常
